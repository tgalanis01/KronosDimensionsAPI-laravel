...
class OvertimeList_Daily implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $dateTime  = Carbon::now();
        $startDate = $dateTime->copy()->startOfDay()->toDateString();
        $endDate = $dateTime->copy()->endOfDay()->toDateString();
        ...
        //mail the files
        $subject = 'OvertimeList_Daily Daily Report';
        $bodyMessage = 'OvertimeList Daily; Daily Report';
